...
public class TronGame {
     ...
     * height of screen
     */
    private static final int HEIGHT = (int) Toolkit.getDefaultToolkit().getScreenSize().getHeight() - 50;
    /**
     * size of bike
     */
...
//    	Uncomment following lines for 4 additional bikes
...
//    			Keyboard.isKeyDown(Keyboard.KEY_NUMPAD9), Keyboard.isKeyDown(Keyboard.KEY_NUMPAD7));
    ...
    private static void setUpEntities() {
        ...
        //Add Orange Bike, controls = arrow keys
    	bikes.add(new Bike(WIDTH/7, HEIGHT/2, BIKE_SIZE, BIKE_SIZE, 1.0f, 0.6471f, 0.0f, 2, "DOWN", "Orange"));
        //Add Blue Bike, controls
    	bikes.add(new Bike(WIDTH*6/7, HEIGHT/2, BIKE_SIZE, BIKE_SIZE, 0.4784f, 1.0f, 0.9843f, 2, "UP", "Blue"));
    	
//    	  Uncomment following lines to add four additional bikes
//        bikes.add(new Bike(WIDTH*3/7, HEIGHT/2, BIKE_SIZE, BIKE_SIZE, 1.0f, 1.0f, 1.0f, 2, "DOWN", "White")); //adds white bike
